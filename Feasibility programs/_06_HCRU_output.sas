...
%let groups=overall;
	...
	data _06_hcru_&ad.&z.&year.;
		set derived._05_hcru_&ad.&z.&year.;
...
PROC SQL;
	...
	, '1' as overall
	FROM _06_hcru_&ad.&z.&year. a inner join derived._02_primary_2 b
		on a.patid=b.patid
	;
QUIT;
...
ods csv file="/home/dingyig/proj/NOV-27/Feasibility/Output/_13_hcru_one_year.csv";
...
data _13_procs&table.; 
		set			
				...
				;
		if group2 in ('<30 mg/dL' , '<65 nmol/L') then group2='<65 nmol/L';
		else if group2 in ('<50 mg/dL', '<105 nmol/L') then group2='<105 nmol/L';
		else if group2 in ('30-<50 mg/dL', '65-<105 nmol/L') then group2='65-<105 nmol/L';
		else if group2 in ('50-<70 mg/dL', '105-<150 nmol/L') then group2='105-<150 nmol/L';
		else if group2 in ('70-<90 mg/dL', '150-<190 nmol/L') then group2='150-<190 nmol/L';
		else if group2 in ('90-<120 mg/dL', '190-<255 nmol/L') then group2='190-<255 nmol/L';
		else if group2 in ('≥70 mg/dL', '≥150 nmol/L') then group2='≥150 nmol/L';
		else if group2 in ('≥90 mg/dL', '≥190 nmol/L') then group2='≥190 nmol/L';
		else if group2 in ('≥120 mg/dL', '≥255 nmol/L') then group2='≥255 nmol/L';
		else if group2 in ('≥150 mg/dL', '≥320 nmol/L') then group2='≥320 nmol/L';
		else if group2='overall' then group2='Overall';
	run;	
...
ods csv file="/home/dingyig/proj/NOV-27/Feasibility/Output/_13_procs_one_year.csv";
