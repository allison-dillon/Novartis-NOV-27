/*Baseline characteristics by gender for MACE populations*/
/*for cohort 1*/
...
data _02_final_1;
	set 
		_02_cohort1one_year1-_02_cohort1one_year11
		_02_cohort1two_years1-_02_cohort1two_years11
		_02_cohort1all1-_02_cohort1all11;
run;	

ods csv file="/home/dingyig/proj/NOV-27/Feasibility/Output/_09_Demos_bygender_1.csv";
proc print data=	_02_final_1 noobs;
run;	
ods csv close;

/*DO AGAIN FOR COHORT 2*/
%macro output(seq, subgroup, whr);
	%do z=2 %to 2;
	%let ad_groups=one_year*two_years*all;
		%do ad=1 %to 3;
...
ods csv file="/home/dingyig/proj/NOV-27/Feasibility/Output/_09_Demos_bygender_2.csv";
