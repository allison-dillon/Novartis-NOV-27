...
* modify variables;
%do z=1 %to 2;
%let groups=overall*cvd*noncvd*mi*pad*stroke*unsta_angina*sta_angina*tia*other*revasc*throm*cabg*endar*pci*angio_stent;
		%do zz=1 %to 16;
...
%macro output(seq, lpa_level1, lpa_level2, whrcl1, whrcl2);
	%do z=1 %to 2;
	%let ad_groups=overall*cvd*noncvd*mi*pad*stroke*unsta_angina*sta_angina*tia*other*revasc*throm*cabg*endar*pci*angio_stent;
	%do zz=1 %to 16;
...
data _13_hcru_&year.;
	...
	set _02_cohort1overall7
		_02_cohort1cvd7
		_02_cohort1noncvd7
		_02_cohort1mi7
		_02_cohort1pad7
		_02_cohort1stroke7
		_02_cohort1unsta_angina7
		_02_cohort1sta_angina7
		_02_cohort1tia7
		_02_cohort1other7
		_02_cohort1revasc7
		_02_cohort1throm7
		...
		_02_cohort2pad7
		_02_cohort2stroke7
		_02_cohort2unsta_angina7
		_02_cohort2sta_angina7
		_02_cohort2tia7
		_02_cohort2other7
		_02_cohort2revasc7
		_02_cohort2throm7
...
ods csv file="/home/dingyig/proj/NOV-27/_hcru_one_year.csv";
proc print data=	_13_hcru_one_year ;
run;	
ods csv close;

ods csv file="/home/dingyig/proj/NOV-27/_hcru_two_years.csv";
proc print data=	_13_hcru_two_years noobs;
run;	
ods csv close;


ods csv file="/home/dingyig/proj/NOV-27/_hcru_all.csv";
...
data _13_procs&table.; 
		set 	WORK._13_procsoverall1&table.7
				WORK._13_procscvd1&table.7
				WORK._13_procsnoncvd1&table.7 
				WORK._13_procsmi1&table.7
				WORK._13_procspad1&table.7
				WORK._13_procsstroke1&table.7 
				WORK._13_procsunsta_angina1&table.7
				WORK._13_procssta_angina1&table.7 
				WORK._13_procstia1&table.7 
				WORK._13_procsother1&table.7
				WORK._13_procsrevasc1&table.7 
				WORK._13_procsthrom1&table.7
				WORK._13_procscabg1&table.7
				WORK._13_procsendar1&table.7
				WORK._13_procspci1&table.7
				WORK._13_procsangio_stent1&table.7
				WORK._13_procsoverall2&table.7 
				WORK._13_procscvd2&table.7
				WORK._13_procsnoncvd2&table.7 
				WORK._13_procsmi2&table.7
				WORK._13_procspad2&table.7
				WORK._13_procsstroke2&table.7 
				WORK._13_procsunsta_angina2&table.7 
				WORK._13_procssta_angina2&table.7 
				WORK._13_procstia2&table.7 
				WORK._13_procsother2&table.7 
				WORK._13_procsrevasc2&table.7 	
				WORK._13_procsthrom2&table.7
				WORK._13_procscabg2&table.7
				WORK._13_procsendar2&table.7
				WORK._13_procspci2&table.7
				WORK._13_procsangio_stent2&table.7
...
proc print data=_13_procs&table.;
run;
...
%year(one_year, years=one_year=1);
%year(two_years,two, years=two_years=1);
