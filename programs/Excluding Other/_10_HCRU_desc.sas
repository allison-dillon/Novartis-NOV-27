...
%macro stat_hcru (seq, lpa_level1, lpa_level2, whrcl1, whrcl2);
	...
	%let groups=overall;
		...
		proc sql;
			create table _10_hosp&z. as select * from derived._07_hosp&ad.&z.&year. where patid in (select distinct patid from _10_sub&z.);
			create table _10_er&z. as select * from derived._08_er&ad.&z.&year. where patid in (select distinct patid from _10_sub&z.) ;
			create table _10_outp&z. as select * from derived._09_outp&ad.&z.&year. where patid in (select distinct patid from _10_sub&z.) ;
		quit;
		...
		* Top 20 causes by subgroups;
			proc sql;
				...
				on a.diag=b.icd10
				where a.patid in (select distinct patid from _10_sub&z.);
...
/* 		_10_descriptive&z.cvd1 - _10_descriptive&z.cvd11 */
/* 		_10_descriptive&z.noncvd1 - _10_descriptive&z.noncvd11 */
/* 		_10_descriptive&z.mi1 - _10_descriptive&z.mi11 */
/* 		_10_descriptive&z.pad1 - _10_descriptive&z.pad11 */
/* 		_10_descriptive&z.stroke1 - _10_descriptive&z.stroke11 */
/* 		_10_descriptive&z.unsta_angina1-_10_descriptive&z.unsta_angina11 */
/* 		_10_descriptive&z.sta_angina1-_10_descriptive&z.sta_angina11 */
/* 		_10_descriptive&z.tia1-_10_descriptive&z.tia11 */
/* 		_10_descriptive&z.other1-_10_descriptive&z.other11 */
/* 		_10_descriptive&z.revasc1-_10_descriptive&z.revasc11 */
/* 		_10_descriptive&z.throm1-_10_descriptive&z.throm11 */
/* 		_10_descriptive&z.cabg1-_10_descriptive&z.cabg11 */
/* 		_10_descriptive&z.endar1-_10_descriptive&z.endar11 */
/* 		_10_descriptive&z.pci1 -_10_descriptive&z.pci11 */
/* 		_10_descriptive&z.angio_stent1-_10_descriptive&z.angio_stent11; */
		cohort=&z.;
		run;
		...
		set 
		_10_outp_topcause&z.overall1 - _10_outp_topcause&z.overall11;
/* 		_10_outp_topcause&z.cvd1 - _10_outp_topcause&z.cvd11 */
/* 		_10_outp_topcause&z.noncvd1 - _10_outp_topcause&z.noncvd11 */
/* 		_10_outp_topcause&z.mi1 - _10_outp_topcause&z.mi11 */
/* 		_10_outp_topcause&z.pad1 - _10_outp_topcause&z.pad11 */
/* 		_10_outp_topcause&z.stroke1 - _10_outp_topcause&z.stroke11 */
/* 		_10_outp_topcause&z.unsta_angina1-_10_outp_topcause&z.unsta_angina11 */
/* 		_10_outp_topcause&z.sta_angina1-_10_outp_topcause&z.sta_angina11 */
/* 		_10_outp_topcause&z.tia1-_10_outp_topcause&z.tia11 */
/* 		_10_outp_topcause&z.other1-_10_outp_topcause&z.other11 */
/* 		_10_outp_topcause&z.revasc1-_10_outp_topcause&z.revasc11 */
/* 		_10_outp_topcause&z.throm1-_10_outp_topcause&z.throm11 */
/* 		_10_outp_topcause&z.cabg1-_10_outp_topcause&z.cabg11 */
/* 		_10_outp_topcause&z.endar1-_10_outp_topcause&z.endar11 */
/* 		_10_outp_topcause&z.pci1 -_10_outp_topcause&z.pci11 */
/* 		_10_outp_topcause&z.angio_stent1-_10_outp_topcause&z.angio_stent11; */
		cohort=&z.;
	run;
	%end;
...
/*one year*/
ods csv file="/home/dingyig/proj/NOV-27/Output/_10_hcru_one_year.csv";
proc print data=derived._10_hcru_one_year;
run;
ods csv close;


ods csv file="/home/dingyig/proj/NOV-27/Output/_10_cause_one_year.csv";
proc print data=derived._10_cause_one_year;
run;
ods csv close;

/*two year*/
ods csv file="/home/dingyig/proj/NOV-27/Output/_10_hcru_two_year.csv";
proc print data=derived._10_hcru_two_years noobs;
run;
ods csv close;


ods csv file="/home/dingyig/proj/NOV-27/Output/_10_cause_two_year.csv";
proc print data=derived._10_cause_two_years noobs;
run;
ods csv close;

/*all follow up */
ods csv file="/home/dingyig/proj/NOV-27/Output/_10_hcru_all.csv";
proc print data=derived._10_hcru_all noobs;
run;
ods csv close;


ods csv file="/home/dingyig/proj/NOV-27/Output/_10_cause_all.csv";
proc print data=derived._10_cause_all noobs;
run;
ods csv close;
