...
%macro output(seq, lpa_level1, lpa_level2, whrcl1, whrcl2);
	%do z=1 %to 2;
	%let ad_groups=overall*mi*pad*stroke*unsta_angina*sta_angina*tia*other*revasc*cvd*anginatia*noncvd;
		%do zz=1 %to 12;
...
options mprint;
%macro year(year, table, years=one_yea);
...
run;
	...
	%do q=1 %to 3;
				...
				%let vars=%scan(aphe_cnt*dial_cnt*revasc_cnt, &q., *);
	...
	data _13_proc&ad.&z.&table.&seq.; 
			length cohort_new group1 group2 cat2 $100.;
			set _13_proc_&ad.out1-_13_proc_&ad.out3;			
				if &z.=1 then cohort_new='Patients with Lp(a) in mg/dL';
				else if &z.=2 then cohort_new='Patients with Lp(a) in nmol/L';
				if &z.=1 then group2="&lpa_level1."; else group2="&lpa_level2."; 
				...
				if cat2='revasc_cnt' then cat2='revasc';
...
data _13_procs&table.; 
		set 	WORK._13_procoverall1&table.1- WORK._13_procoverall1&table.11
				WORK._13_proccvd1&table.1- WORK._13_proccvd1&table.11
				WORK._13_procnoncvd1&table.1 - WORK._13_procnoncvd1&table.11
				WORK._13_procmi1&table.1- WORK._13_procmi1&table.11
				WORK._13_procpad1&table.1- WORK._13_procpad1&table.11
				WORK._13_procstroke1&table.1 - WORK._13_procstroke1&table.11
				WORK._13_procunsta_angina1&table.1 - WORK._13_procunsta_angina1&table.11
				WORK._13_procsta_angina1&table.1 - WORK._13_procsta_angina1&table.11
				WORK._13_proctia1&table.1 - WORK._13_proctia1&table.11
				WORK._13_procother1&table.1 - WORK._13_procother1&table.11
				WORK._13_procrevasc1&table.1 - WORK._13_procrevasc1&table.11
				WORK._13_procanginatia1&table.1- WORK._13_procanginatia1&table.11
				
				WORK._13_procoverall2&table.1 - WORK._13_procoverall2&table.11
				WORK._13_proccvd2&table.1- WORK._13_proccvd2&table.11
				WORK._13_procnoncvd2&table.1 - WORK._13_procnoncvd2&table.11
				WORK._13_procmi2&table.1- WORK._13_procmi2&table.11
				WORK._13_procpad2&table.1- WORK._13_procpad2&table.11
				WORK._13_procstroke2&table.1 - WORK._13_procstroke2&table.11
				WORK._13_procunsta_angina2&table.1 - WORK._13_procunsta_angina2&table.11
				WORK._13_procsta_angina2&table.1 - WORK._13_procsta_angina2&table.11
				WORK._13_proctia2&table.1 - WORK._13_proctia2&table.11
				WORK._13_procother2&table.1 - WORK._13_procother2&table.11
				WORK._13_procrevasc2&table.1 		- WORK._13_procrevasc2&table.11
				WORK._13_procanginatia2&table.1- WORK._13_procanginatia2&table.11
